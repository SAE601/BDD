    ...
    <div class="tab-content" id="tab-2">
      ...
      <div class="details-container">
        <div class="details-box">
          ...
          <p><?php echo htmlspecialchars($hour); ?> - <?php echo htmlspecialchars($water); ?> <button onclick="toggleDetails('irrigation1')">+</button></p>
          ...
          <p><?php echo htmlspecialchars($hour); ?> - <?php echo htmlspecialchars($water); ?><button onclick="toggleDetails('irrigation2')">+</button></p>
          <div id="irrigation2" class="irrigation-details">Recette: 60mg N, 40mg P</div>
          <p><?php echo htmlspecialchars($hour); ?> - <?php echo htmlspecialchars($water); ?><button onclick="toggleDetails('irrigation3')">+</button></p>
